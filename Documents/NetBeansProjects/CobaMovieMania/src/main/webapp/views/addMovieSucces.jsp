<%-- 
    Document   : addMovieSucces
    Created on : Oct 31, 2024, 2:37:07 PM
    Author     : acer
--%>
...
<html lang="en">
  <head>
    ...
    <style>
      body {
        ...
        height: 100vh;
        margin: 0;
        background-image: url("/aset_movie/image/bgAddSucces.jpeg");
  ...
  <body>
    <div class="success-container">
      ...
      <!-- Success Text -->
      <div class="success-text">Movie successfully added!</div>
    </div>
